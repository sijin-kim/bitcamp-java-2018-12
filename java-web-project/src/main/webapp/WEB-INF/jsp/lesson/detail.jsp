...
<c:otherwise>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="Date" class="form-control-plaintext" id="startDate" 
                name='startDate' value='${lesson.startDate}'readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="Date" class="form-control-plaintext" id="endDate" 
                name='endDate' value='${lesson.endDate}'readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control-plaintext" id="contents" 
                name='totalHours' value='${lesson.totalHours}'readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control-plaintext" id="dayHours" 
                name='dayHours' value='${lesson.dayHours}'readonly>
    </div>
  </div>
